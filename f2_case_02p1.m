function output = f2_case_02p1(c)
%-----------
% Case 2.1
%-----------
...
%
% Dispersion is simulated for the real case.
...
%    the system has reached equilibrium -- TODO UPDATE
% --------------------------------------------------
